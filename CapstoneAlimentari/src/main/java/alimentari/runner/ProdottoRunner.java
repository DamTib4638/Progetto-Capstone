...
//				.scaffale(scafForno).tipoProdotto(TipoProdotto.SNACK_DOLCE).build();
...
//				.scaffale(scafFrutta).tipoProdotto(TipoProdotto.PESCE).build();
...
//				.scaffale(scafFrutta).tipoProdotto(TipoProdotto.PASTA).build();
...
//				.scaffale(scafFrutta).tipoProdotto(TipoProdotto.INTIMO_ADULTO).build();
...
//				.scaffale(scafCasa).tipoProdotto(TipoProdotto.ACQUA).build();
...
//				.scaffale(scafCasa).tipoProdotto(TipoProdotto.BEVANDA_ALCOLICA).build();
...
//				.scaffale(scafIgPer).tipoProdotto(TipoProdotto.ACCESSORI_BIMBO).build();
...
//				.scaffale(scafIgPer).tipoProdotto(TipoProdotto.CIBO_BIMBO).build();
